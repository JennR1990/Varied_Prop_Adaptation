...
reach_par <-
 ...
 write.csv(reach_model$slow,file = "data/slowprocess.csv", quote = FALSE, row.names = FALSE)
```
...
#This code requires the list of either 1 or -1 depending on data type and the actual reaches or localizations.  So i will feed it only 12 trials at a time in a for loop. 
asymptoticDecayFit
```
